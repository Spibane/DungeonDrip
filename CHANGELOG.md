...
- Added two buttons at the top of the vendor panel for the filters worth flipping mid-shop: whether owned pieces are listed, and whether the list is held to your current job. They write the shared settings, so the panel says that the duty list changes with them
